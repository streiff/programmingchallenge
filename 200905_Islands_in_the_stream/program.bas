...
35  IF LEN(FILENAME$) = 0 THEN GOTO 30
...
165   IF LEN(FILENAME$) = 0 THEN GOTO 160
170 WEND 
500 SYSTEM
...
6402     '
6403     ' northwest
6404     IF X6000 = 0 OR Y6000 = 1 THEN GOTO 6410
6405       IF FNCHARAT$(LINES$(X6000 - 1), Y6000 - 1) <> TARGET$ THEN GOTO 6410
6406         MID$(LINES$(X6000 - 1), Y6000 - 1, 1) = SOURCE$
6407         SQFND = SQFND + 1
6410     '
6411     ' north
6412     IF X6000 = 0 THEN GOTO 6450
